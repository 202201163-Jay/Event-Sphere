...
import './participant_log_reg.css'
        ...
        <div id="container">
            <div className="container-form sign-up">
                <form className="forms">
                    ...
                    <input  type="text" className="inputs" id="first-name" placeholder="First Name"/>
                    <input  type="text" className="inputs" id="email" placeholder="Email"/>
                    <input  type="password" className="inputs" id="password" placeholder="Password"/>
                    <div className="verification">
                        <input type="checkbox" className="inputs" id="verify"/>Student Verification
                    </div>
            ...
            <div className="toggle-container">
                <div className="toggle">
                    <div className="toggle-panel toggle-left">
                        ...
                        <p>Log In Using Your Personal Details</p>
                        <button className="hide" id="login" onClick={handler}>LOG IN</button>
                    </div>

                    <div className="toggle-panel toggle-right">
                        <h1>Thank You for Visiting Us!</h1>
                        <p>Create an Account to use features of our site</p>
